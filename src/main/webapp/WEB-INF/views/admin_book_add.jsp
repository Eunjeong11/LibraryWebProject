                ...
                <div class="container px-4 px-lg-5">
                    <div class="row justify-content-center">
                        <div class="card shadow-lg border-5 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form action="adminbookWriteSave.do" method="POST enctype="multipart/form-data">

                                    <!--                                    ISBN10 & 장르-->
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="bcode" type="text" placeholder="BCODE를 입력해주세요." name="bcode" /> <label for="inputISBN">BCODE</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input class="form-control" id="genre" type="text" placeholder="장르를 입력해주세요." name="genre" /> <label for="inputGenre">장르</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="bname" type="text" placeholder="제목 명을 입력해주세요." name="bname" /> <label for="inputFirstName">제목</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="wname" type="text" placeholder="저자 명을 입력해주세요." name="wname" /> <label for="inputLastName">저자</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="publisher" type="text" placeholder="출판사 명을 입력해주세요." name="publisher" /> <label for="inputLastName">출판사</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                    <!-- <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="publisheddate" type="date" placeholder="발행일을 입력해주세요." name="publisheddate" /> <label for="inputBookCount">발행일</label> -->
                                    </div>
                                    </div>
                                    </div>
                                    ...
                                    <!-- <div class="form-floating mb-3">
                                     ...
                                     <!--<label class="form-label" for="inputBookImage">책의 이미지
                                        파일을 삽입해주세요.</label> <input class="form-control" id="upload_f" type="file" placeholder="이미지 파일을 선택해주세요." name="upload_f" enctype="multipart/form-data" />--> 
